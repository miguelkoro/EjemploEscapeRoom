...
const Ray = (props) => {
    ...
    const drawLine = (ctx, width, height, lineWidth, color)=> {
        ...
        const maxFrequency = props.frequency; // Frecuencia máxima
    ...
    const width = props.boxWidth * 0.8; // Escala proporcional al ancho del contenedor
    const height = props.boxHeight * 0.5; // Escala proporcional al alto del contenedor
    canvas.width = width;
    canvas.height = height;

    drawWave(ctx, width, height); // Redibuja la onda con las nuevas dimensiones
    };
